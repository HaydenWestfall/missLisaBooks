  ...
  cards: any[] = [
    {
      ...
      alt: 'Child overcoming a disability while learning',
    },
    {
      description:
      ...
      alt: 'Child practicing reading with repetitive text',
    },
    {
      description:
      ...
      alt: 'Child learning to read with the support of an intervention specialist',
    },
  ];
